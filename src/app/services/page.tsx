    ...
    <main className="pt-16 min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
      ...
      <section className="relative py-12 lg:py-16">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-10 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <ul className="space-y-3 mb-6">
                {[
                  ...
                  'Complex e-commerce with custom features',
                  'AI/ML powered solutions & automation',
                  'Full-stack SaaS development',
                  'Legacy system modernization',
                ].map((item, idx) => (
                  <li key={idx} className="flex items-start gap-3 text-slate-300">
                    <div className="w-6 h-6 rounded-full bg-gradient-to-br from-orange-500 to-pink-600 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-pink-500/20 rounded-3xl blur-3xl" />
              <div className="relative bg-gradient-to-b from-slate-800/90 to-slate-900/90 border border-slate-700/50 rounded-3xl p-8">
                <div className="text-center mb-8">
                  <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-pink-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                    <Sparkles className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2">Custom Quote</h3>
                  <p className="text-slate-400">Tailored to your requirements</p>
                </div>
                
                <div className="space-y-4 mb-8">
                  {[
                    { label: 'Dedicated Project Manager', included: true },
                    { label: 'Priority Support & Communication', included: true },
                    { label: 'Flexible Payment Plans', included: true },
                    { label: 'Extended Warranty & Maintenance', included: true },
                    { label: 'Source Code & Documentation', included: true },
                  ].map((feature, idx) => (
      ...
      <section className="py-24 border-t border-slate-800/50 relative">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 pt-12 border-t border-slate-800/50">
            {[
              { value: 'Fast', label: 'Delivery in Days' },
              { value: 'Fixed', label: 'No Hidden Costs' },
              { value: 'Free', label: 'Unlimited Revisions' },
            ].map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500 mb-2">{stat.value}</div>
